...
describe('instantiate client', () => {
  ...
  describe('baseUrl', () => {
    ...
    afterEach(() => {
      process.env['DWOLLA_BASE_URL'] = undefined;
    });
    ...
    test('env variable', () => {
      process.env['DWOLLA_BASE_URL'] = 'https://example.com/from_env';
      const client = new Dwolla({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
    ...
    test('empty env variable', () => {
      process.env['DWOLLA_BASE_URL'] = ''; // empty
      const client = new Dwolla({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
      });
      expect(client.baseURL).toEqual('https://api.dwolla.com');
    });

    test('blank env variable', () => {
      process.env['DWOLLA_BASE_URL'] = '  '; // blank
      const client = new Dwolla({
        bearerToken: 'My Bearer Token',
        username: 'My Username',
        password: 'My Password',
