...
export namespace Customers {
  export type Controller = CustomersAPI.Controller;
  export type UnverifiedBusinessCustomer = CustomersAPI.UnverifiedBusinessCustomer;
  export type UnverifiedCustomer = CustomersAPI.UnverifiedCustomer;
  export type VerifiedBusinessCustomer = CustomersAPI.VerifiedBusinessCustomer;
  export type VerifiedPersonalCustomer = CustomersAPI.VerifiedPersonalCustomer;
  export type VerifiedSolePropCustomer = CustomersAPI.VerifiedSolePropCustomer;
  export type CustomerRetrieveResponse = CustomersAPI.CustomerRetrieveResponse;
  export type CustomerUpdateResponse = CustomersAPI.CustomerUpdateResponse;
  export type CustomerListResponse = CustomersAPI.CustomerListResponse;
